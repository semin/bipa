...
/*
 * assign_j4_features(int, int *, ALI *,
 *         SST *, PSA *, HBD *, TEM *)
 *
 * Assign features (set j4)
 *
 */
int assign_j4_features (int nstr, int alilen, ALI *aliall,
  ...
  for (i=0; i<nstr; i++) {
    ...
    _j4_0(aliall[str_lst[i]].sequence, alilen, sstall[i], psaall[i], hbdall[i], temall[i], strtpos, endpos);
    _j4_1(aliall[str_lst[i]].sequence, alilen, sstall[i], psaall[i], hbdall[i], temall[i], strtpos, endpos);
    _j4_2(aliall[str_lst[i]].sequence, alilen, sstall[i], psaall[i], hbdall[i], temall[i], strtpos, endpos);
    _j4_3(aliall[str_lst[i]].sequence, alilen, sstall[i], psaall[i], hbdall[i], temall[i], strtpos, endpos);
    _j4_4(aliall[str_lst[i]].sequence, alilen, sstall[i], psaall[i], hbdall[i], temall[i], strtpos, endpos);
    _j4_5(aliall[str_lst[i]].sequence, alilen, sstall[i], psaall[i], hbdall[i], temall[i], strtpos, endpos);
    _j4_6(aliall[str_lst[i]].sequence, alilen, sstall[i], psaall[i], hbdall[i], temall[i], strtpos, endpos);
    _j4_7(aliall[str_lst[i]].sequence, alilen, sstall[i], psaall[i], hbdall[i], temall[i], strtpos, endpos);
    _j4_8(aliall[str_lst[i]].sequence, alilen, sstall[i], psaall[i], hbdall[i], temall[i], strtpos, endpos);
    _j4_9(aliall[str_lst[i]].sequence, alilen, sstall[i], psaall[i], hbdall[i], temall[i], strtpos, endpos);
    _j4_10(aliall[str_lst[i]].sequence, alilen, sstall[i], psaall[i], hbdall[i], temall[i], strtpos, endpos);
    _j4_11(aliall[str_lst[i]].sequence, alilen, sstall[i], psaall[i], hbdall[i], temall[i], strtpos, endpos);
    _j4_12(aliall[str_lst[i]].sequence, alilen, sstall[i], psaall[i], hbdall[i], temall[i], strtpos, endpos);
    _j4_13(aliall[str_lst[i]].sequence, alilen, sstall[i], psaall[i], hbdall[i], temall[i], strtpos, endpos);
  }
  return 0;
}

/**********************************************************************************/
int _j4_0 (char *sequence, int alilen, SST sst, PSA psa, HBD hbd, TEM tem, int strtpos, int endpos) {
             /* secondary structure and phi angle   */
...
/**********************************************************************************/
int _j4_1 (char *sequence, int alilen, SST sst, PSA psa, HBD hbd, TEM tem, int strtpos, int endpos) {
             /* solvent accessibility   */
...
/**********************************************************************************/
int _j4_2 (char *sequence, int alilen, SST sst, PSA psa, HBD hbd, TEM tem, int strtpos, int endpos) {
             /* hydrogen bond to mainchain CO   */
...
/**********************************************************************************/
int _j4_3 (char *sequence, int alilen, SST sst, PSA psa, HBD hbd, TEM tem, int strtpos, int endpos) {
             /* hydrogen bond to mainchain NH   */
...
/**********************************************************************************/
int _j4_4 (char *sequence, int alilen, SST sst, PSA psa, HBD hbd, TEM tem, int strtpos, int endpos) {
             /* hydrogen bond to other sidechain/heterogen   */
...
/**********************************************************************************/
int _j4_5 (char *sequence, int alilen, SST sst, PSA psa, HBD hbd, TEM tem, int strtpos, int endpos) {
             /* cis-peptide bond   */
...
/**********************************************************************************/
int _j4_6 (char *sequence, int alilen, SST sst, PSA psa, HBD hbd, TEM tem, int strtpos, int endpos) {
             /* hydrogen bond to heterogen   */
...
/**********************************************************************************/
int _j4_7 (char *sequence, int alilen, SST sst, PSA psa, HBD hbd, TEM tem, int strtpos, int endpos) {
             /* disulphide   */
...
/**********************************************************************************/
int _j4_8 (char *sequence, int alilen, SST sst, PSA psa, HBD hbd, TEM tem, int strtpos, int endpos) {
             /* mainchain to mainchain hydrogen bonds (amide)   */
...
/**********************************************************************************/
int _j4_9 (char *sequence, int alilen, SST sst, PSA psa, HBD hbd, TEM tem, int strtpos, int endpos) {
             /* Mainchain to mainchain hydrogen bonds (carbonyl)   */
...
/**********************************************************************************/
int _j4_10 (char *sequence, int alilen, SST sst, PSA psa, HBD hbd, TEM tem, int strtpos, int endpos) {
             /* DSSP   */
...
/**********************************************************************************/
int _j4_11 (char *sequence, int alilen, SST sst, PSA psa, HBD hbd, TEM tem, int strtpos, int endpos) {
             /* positive phi angle   */
...
/**********************************************************************************/
int _j4_12 (char *sequence, int alilen, SST sst, PSA psa, HBD hbd, TEM tem, int strtpos, int endpos) {
             /* percentage accessibility   */
...
/**********************************************************************************/
int _j4_13 (char *sequence, int alilen, SST sst, PSA psa, HBD hbd, TEM tem, int strtpos, int endpos) {
             /* Ooi number   */
